...
# etc.
START_URL = "https://www.jrcigars.com/cigars-by-strength/mellow-to-medium-bodied-cigars/?sz=60"
...
LOG_FILE = "jrcigars_mellow_to_medium_errors.log"
        ...
        items = page.evaluate(
            ...
            () => {
                ...
                return tiles.map(tile => {
                    ...
                    if (priceEl) {
                        const match = priceEl.textContent.replace(/[,\\s]/g, "").match(/\\$?([0-9]+(\\.[0-9]+)?)/);
    ...
    with sync_playwright() as p:
        ...
        while True:
            if start == 0:
                ...
                url = f"https://www.jrcigars.com/cigars-by-strength/mellow-to-medium-bodied-cigars/?start={start}&sz={page_size}"

            print(f"\n=== Scraping listing page start={start} ===")
        ...
        browser.close()
    conn.close()
    print("\nJR Cigars mellow-to-medium scraping completed.")
