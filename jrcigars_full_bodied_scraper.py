...
START_URL = "https://www.jrcigars.com/cigars-by-strength/full-bodied-cigars/?sz=60"
...
LOG_FILE = "jrcigars_full_bodied_errors.log"
...
def run_scraper():
    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            print(f"\n=== JR Full-Bodied Listing start={start} ===")
        ...
        browser.close()
    conn.close()
    print("\nJR Cigars full-bodied scraping completed.")
