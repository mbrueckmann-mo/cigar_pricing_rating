...
START_URL = "https://www.jrcigars.com/cigars-by-strength/mellow-bodied-cigars/?sz=60"
...
LOG_FILE = "jrcigars_mellow_bodied_errors.log"
...
def scrape_listing_page(page, url):
    """
    Scrapes a single JR listing page.
    Returns: list of { url, brand, name, size, price }
    """
    try:
...
def run_scraper():
    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            print(f"\n=== JR Mellow-Bodied Listing start={start} ===")
        ...
        browser.close()
    conn.close()
    print("\nJR Cigars mellow-bodied scraping completed.")
