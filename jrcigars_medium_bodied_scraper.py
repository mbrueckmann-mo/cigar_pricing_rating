...
START_URL = "https://www.jrcigars.com/cigars-by-strength/medium-bodied-cigars/?sz=60"
...
LOG_FILE = "jrcigars_medium_bodied_errors.log"
...
def run_scraper():
    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            print(f"\n=== JR Medium-Bodied Listing start={start} ===")
        ...
        browser.close()
    conn.close()
    print("\nJR Cigars medium-bodied scraping completed.")
